  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between gap-3 px-4">
        <Link to="/" data-testid="logo-link" aria-label="MathTopon — Αρχική" className="group min-w-0 shrink-0">
          <img
            src={`${process.env.PUBLIC_URL}/mathtopon-logo.svg`}
            alt="MathTopon — Ο τόπος των Μαθηματικών"
            className="h-[3.15rem] w-auto max-w-[10.5rem] transition-transform duration-200 group-hover:scale-[1.02] min-[430px]:max-w-[13.5rem]"
          />
        </Link>
